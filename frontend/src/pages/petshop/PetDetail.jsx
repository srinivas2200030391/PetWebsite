      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <h2 className="text-sm title-font text-gray-500 tracking-widest uppercase">{pet.category}</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{pet.name}</h1>
            
            <div className="flex mb-4">
              <span className="flex items-center">
                <span className="text-gray-600">Status: </span>
                <span className={`ml-2 ${pet.status === 'Available' ? 'text-green-500' : 'text-red-500'}`}>
                  {pet.status}
                </span>
              </span>
            </div>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex flex-col gap-2 w-full">
                ...
                <div className="flex justify-between">
                  ...
                  <span><strong>Weight:</strong> {pet.weight}</span>
                </div>
                <div className="flex justify-between">
                  <span><strong>Height:</strong> {pet.height}</span>
                  <span><strong>Life Span:</strong> {pet.lifeSpan}</span>
                </div>
                <div className="flex justify-between">
                  <span><strong>Group:</strong> {pet.group}</span>
                </div>
              </div>
            </div>

            <div className="flex items-center">
              <span className="title-font font-medium text-2xl text-gray-900">₹{pet.price}</span>
