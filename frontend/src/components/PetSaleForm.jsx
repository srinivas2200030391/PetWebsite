...
export default function PetSaleForm() {
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-12">
          <motion.div variants={itemVariants} className="border-b border-gray-900/10 pb-12">
            <h2 className="text-3xl font-bold leading-7 text-gray-900">Pet Sale Form</h2>
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Please fill in the details to list your pet for sale.
            </p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
              ...
              {/* Pet Lineage */}
              <motion.div variants={itemVariants} className="sm:col-span-2">
                <label htmlFor="petLineage" className="block text-sm font-medium leading-6 text-gray-900">
                  Pet Lineage
                </label>
                <div className="mt-2">
                  <input
              ...
              {/* Shop Address */}
              <motion.div variants={itemVariants} className="col-span-full">
                <label htmlFor="shop-address" className="block text-sm font-medium leading-6 text-gray-900">
                  Shop Address
                </label>
                <div className="mt-2">
                  <input
