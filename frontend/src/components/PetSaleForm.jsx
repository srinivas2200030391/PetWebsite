      ...
      <div className="max-w-2xl mx-auto border border-gray-300 rounded-lg p-9 mt-20">
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-2xl font-semibold leading-7 text-gray-900">Product Data</h2>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
              ...
              <div className="sm:col-span-1">
                ...
                <div className="mt-2">
                  ...
                  >
                    <option value="">Select type</option>
                    <option value="dog">availability</option>
                    <option value="cat">Not availability</option>
                  </select>
                </div>
              </div>
